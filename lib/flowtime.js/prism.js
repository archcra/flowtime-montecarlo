...
function prism_1() {
    ...
    if (r) {
        ...
        document.addEventListener && !r.hasAttribute("data-manual") && document.addEventListener("PrismHighlight", t.highlightAll)
    }
};
...
function prism_2() {
    ...
    addEventListener("flowtimenavigation", r);
